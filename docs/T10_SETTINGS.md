...
На клиентских экранах Настройки открываются кнопкой с инициалом в верхней шапке. Кнопка имеет
явное доступное имя, 44 px touch target, видимый focus и `aria-current="page"` на settings routes.
Во время сохранения тренировки она отключена вместе с нижней навигацией. Внизу остаются
Сегодня, План, Прогресс и Тренер; в режиме `base_lessons` Тренер пока скрыт.
