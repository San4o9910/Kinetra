...
APP='4a4560fac325dc5a09f8ca124ea6101072558b72';BASE='9a283868f893012f87ad1d8daf54aefb29d3ca36';RUNTIME='73b665065e00a5b375e90f701373b3e0856a0386';MERGED='28448a8c0a243b1f7f63aeb2598ec5f9ef1f7ef8';CONTROL='0dbeb47cb475011f393e23b48bd8998e69b5cc92'
IMAGES={'backend': 'ghcr.io/san4o9910/kinetra-backend@sha256:68ce52b34e25b1129357ea80fe2e5c66e87b5b00e9fcbc421c78672c06c3e6da', 'frontend': 'ghcr.io/san4o9910/kinetra-frontend@sha256:03c96b829c4b4b6cb336aae4685e4eb0deaccefae5c7e335a6a3c8dd662c43e3'}
CONTAINERS={'backend':'9a2493acbb5a2a01075397192d3f67457a9c8f66dc5ff104b9f120a23b9e9a88','frontend':'3fea1db8ee7972c09a984a9c5cbdb53fb3793abe05091fdd1c6911eb15c82372','postgres':'a6d4870c61fae621ba44e772a11d5ef2a551e32944e6cc0487bd484c124ebad1'}
...
def main():
 ...
 pr=api('/pulls/29');assert pr['merged'] and pr['merge_commit_sha']==MERGED and pr['head']['sha']==APP
 ...
 success(35827608901,MERGED,'.github/workflows/ci.yml',3)
 success(35825648185,'cb5f183e1c724f958540802d01cf54a9d2d12c6a','.github/workflows/kinetra-availability.yml',1)
 success(35827655982,CONTROL,'.github/workflows/kinetra-training-experience-images.yml',1)
 art=api('/actions/artifacts/10736141004');assert not art['expired'] and art['workflow_run']['id']==35827655982 and art['workflow_run']['head_sha']==CONTROL
 digest='b6123321f189ed0fe76bf697aa0f35923b88690e08d7c6edc943aa1a7201494e';assert art['digest']=='sha256:'+digest
 raw=api('/actions/artifacts/10736141004/zip',archive=True);assert hashlib.sha256(raw).hexdigest()==digest
 with zipfile.ZipFile(io.BytesIO(raw)) as z:
  ...
  def member(name):
   ...
   return z.read(info)
  source=json.loads(member('source-gates.json'));assert source['app_commit']==APP and source['base_commit']==BASE and source['merge_commit']=='0cd12aeae60d6f15d637908576b395277ba5e268'
 ...
 app=pathlib.Path(os.environ['APP_CHECKOUT']);migrations={p.name:hashlib.sha256(p.read_bytes()).hexdigest() for p in sorted((app/'apps/backend/migrations').glob('*.sql'))};assert len(migrations)==20
