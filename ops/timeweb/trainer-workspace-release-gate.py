...
APP='5f9fbea3ab2ed75f5da79d3fb542be4525b00aa3';BASE='5b208925884cdf1038a9a586edfa5bbe28fd1c0e';RUNTIME='73b665065e00a5b375e90f701373b3e0856a0386';MERGED='9d6dced30e194a418016c9e45e5d353e50786cb1';CONTROL='fe5da967d86fd9f0cf2d1e62cdefb4f6c73646ac'
IMAGES={'backend':'ghcr.io/san4o9910/kinetra-backend@sha256:34c468073228ff8a88e99d2cabbe6e1ba830b95afc2d2fc955a72d20eb0a02cb','frontend':'ghcr.io/san4o9910/kinetra-frontend@sha256:3857f2a9d620bd3e742c34023bef8cded15f57e6dfe8ad21fc8c4a3e1018e4a2'}
CONTAINERS={'backend':'fa83f342eca9a9934b8e3a2345d8239a71957ce339ac2e525f9ab8cc16d3ffb2','frontend':'20d864e33c14c7e08c9b6e2368d128589bc994d6268c2880cdf2b8abf72640d9','postgres':'a6d4870c61fae621ba44e772a11d5ef2a551e32944e6cc0487bd484c124ebad1'}
...
def main():
 ...
 pr=api('/pulls/25');assert pr['merged'] and pr['merge_commit_sha']==MERGED and pr['head']['sha']==APP
 ...
 success(35336978393,MERGED,'.github/workflows/ci.yml',3)
 success(35335012967,'0821637b35c7c782529052b854587aa7e6a1a7f5','.github/workflows/kinetra-availability.yml',1)
 success(35337332290,CONTROL,'.github/workflows/kinetra-trainer-workspace-images.yml',1)
 art=api('/actions/artifacts/10543731012');assert not art['expired'] and art['workflow_run']['id']==35337332290 and art['workflow_run']['head_sha']==CONTROL
 digest='7c6ac0c8e2e118424d85470f3a4e712ca643f41e78115fab871a02af57f3a3a9';assert art['digest']=='sha256:'+digest
 raw=api('/actions/artifacts/10543731012/zip',archive=True);assert hashlib.sha256(raw).hexdigest()==digest
 with zipfile.ZipFile(io.BytesIO(raw)) as z:
  ...
  def member(name):
   ...
   return z.read(info)
  source=json.loads(member('source-gates.json'));assert source['app_commit']==APP and source['base_commit']==BASE and source['merge_commit']=='81800b1eb40454be1d5dd3334c535b03f4eddf9f'
 ...
 app=pathlib.Path(os.environ['APP_CHECKOUT']);migrations={p.name:hashlib.sha256(p.read_bytes()).hexdigest() for p in sorted((app/'apps/backend/migrations').glob('*.sql'))};assert len(migrations)==16
 ...
 path=pathlib.Path(os.environ['RUNNER_TEMP'],'kinetra-trainer-workspace-request.json');fd=os.open(path,os.O_WRONLY|os.O_CREAT|os.O_EXCL,0o600)
