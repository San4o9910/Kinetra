...
def main():
 ...
 selected={(c['Config'].get('Labels') or {}).get('com.docker.compose.service'):c for c in containers if (c['Config'].get('Labels') or {}).get('com.docker.compose.project')=='kinetra-production'}
