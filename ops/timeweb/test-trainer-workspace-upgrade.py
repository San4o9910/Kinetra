...
p=pathlib.Path(__file__).with_name('trainer-workspace-upgrade-host.py');spec=importlib.util.spec_from_file_location('upgrade',p);u=importlib.util.module_from_spec(spec);spec.loader.exec_module(u)
